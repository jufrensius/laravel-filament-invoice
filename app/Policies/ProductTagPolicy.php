...
class ProductTagPolicy
{
    ...
    {
        return $user->can('view-any ProductTag');
    }
    ...
    {
        return $user->can('view ProductTag');
    }
    ...
    {
        return $user->can('create ProductTag');
    }
    ...
    {
        return $user->can('update ProductTag');
    }
    ...
    {
        return $user->can('delete ProductTag');
    }
    ...
    {
        return $user->can('restore ProductTag');
    }
    ...
    {
        return $user->can('force-delete ProductTag');
    }
}
